	...
	<div class="row" style="padding:20px">
		...
		<div class="col-md-3">
			<div class="card bg-light" style="width:300px">
				  ...
				  <div class="card-body"><p class="card-text">No.of total books:<?php echo get_book_count(); ?></p>
		...
		<div class="col-md-3">
			<div class="card bg-light" style="width:300px">
				  ...
				  <div class="card-body"><p class="card-text">No.of book's category:<?php echo get_category_count();?></p>
		...
		<div class="col-md-3">
			<div class="card bg-light" style="width:300px">
				  ...
				  <div class="card-body"><p class="card-text">No.of avilable Authors:<?php echo get_author_count();?></p>
